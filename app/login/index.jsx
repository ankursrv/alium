                ...
                <div className='flex items-center'>
                    ...
                    <div className='px-[6rem] w-1/2 mx-auto'>
                        ...
                        <div className='mb-12'>
                            ...
                            <p className='text-xl leading-[30px] mt-3'>Welcome back! please enter your details</p>
                        </div>
                        {/* form  */}

                        <form>
                            <div className="mb-5">
                                <label for="email" className="block mb-[6px] font-semibold text-black">Email</label>
                                <input type="email" id="email" className="bg-white border border-borderPrimary text-black text-base font-semibold rounded-lg block w-full py-3 px-4 dark:placeholder-gray-light placeholder:font-normal" placeholder="john.doe@company.com" required />
                            </div>
                            <div className="mb-8 relative">
                                <label for="password" className="block mb-[6px] font-semibold text-black">Password</label>
                                <input type="password" id="password" className="bg-white border border-borderPrimary text-black text-base font-semibold rounded-lg block w-full py-3 px-4 dark:placeholder-gray-light placeholder:font-normal" placeholder="Password" required />
                                {/* Eye Icon  */}
                                <Image
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-8">
                                    ...
                                    />
                                    <div>
                                        <a className='font-bold text-primary' href="#">Forgot password</a>
                                    </div>
                                </div>
                            </div>
                            <Button
                        ...
                        <div className='flex flex-col gap-6 mt-6'>
                            ...
                            {/* item-2  */}
                            <div>
                                <p className="text-center font-bold text-black bg-white w-fit mx-auto px-8 relative z-20">OR</p>
                                {/* line  */}
